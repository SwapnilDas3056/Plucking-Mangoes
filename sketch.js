...
function setup() {
	...
	mango1 = new Mango(1350,160,30);
	mango2 = new Mango(1420,240,30);
	mango3 = new Mango(1250,180,30);
	mango4 = new Mango(1300,250,30);
	mango5 = new Mango(1360,320,30);
	mango6 = new Mango(1150,280,30);
  mango7 = new Mango(1500,280,30);
  mango8 = new Mango(1220,320,30);
...
function draw() {
  ...
  fill("black");
  textSize(36);
  text("Press the Spacebar to get another chance", 160,160);
  ground.display();
  tree.display();
  boy.display();
  stone.display();
